...
def parse_cl_args():
    ...
    parser.add_argument("-c", type=str, default='',dest='c',help='add a comment about result')
    ##sumo params
    parser.add_argument("-gui",default=False,action='store_true',dest='gui',help='use gui, default:False')
    parser.add_argument("-sumocfg",type=str,default='1_1',dest='sumocfg',help='path to desired simulation sumo configuration file')
    parser.add_argument("-roadnet",type=str,default='1_1',dest='roadnet',help = 'raodnet flie name')

    parser.add_argument("-total_episodes",type=int,default=200,dest='total_episodes',help='total simulation episodes')
    parser.add_argument("-max_steps",type=int,default=5400,dest='max_steps',help='max steps in each simulaiton episode')
    parser.add_argument("-green_duration",type=int,default=30,dest='green_duration',help="duration of green light")
